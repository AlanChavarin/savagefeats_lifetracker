...
function LifeCounter() {
  ...
  return (
    ...
    <div className="relative">
      ...
      <div className="bg-white text-[10vh] sm:text-[12vh] md:text-[15vh] flex justify-center absolute bottom-0 left-[50%] translate-x-[-50%] px-[4vw] rounded-t-[16px] md:rounded-t-[32px] box-shadow pointer-events-none select-none">
        {properTime}
      </div>
